...
// manager.addProduct("Manzana", "una rica manzana roja", 1000, "imagen de manzana", 1222, 1)
// manager.addProduct("Pera", "pera dulce la mas dulce", 1500, "imagen de pera", 4562, 7)
const newProduct1 = {title:"Manzana", description:"una rica manzana roja", price:1000, thumbnail:"imagen de manzana", code:1222, stock:1}
...
/*Mostrar producto*/
manager.getProduct().then(product => console.log(product))
